...
const enUS: Record<string, string> = {
  ...
  "login.wizard.keylessStepDescription":
    "Connect to {provider} and discover local models — no API key needed.",
  ...
  "login.wizard.discoverKey": "Test & discover",
  "login.wizard.discoverKeyTesting": "Testing API key & discovering models...",
  "login.wizard.discoverKeySuccess": "API key works · {count} models",
  "login.wizard.discoverKeyFail": "Test failed: {error} (you can still save)",
  "login.wizard.skipConfirm": "Click again to confirm skip",
  "login.wizard.custom.title": "Custom provider",
  "login.wizard.custom.name": "Name (optional)",
  "login.wizard.custom.baseUrl": "Base URL (OpenAI-compatible)",
  "login.wizard.custom.apiKey": "API key",
  "login.wizard.custom.requiredError": "Enter a base URL and an API key.",
  ...
  "login.apiKey.providerMissingError":
    "Built-in provider configuration for template {templateId} was not found. Please try again later.",
  "login.apiKey.saveError": "Failed to save API key: {error}",
  "login.apiKey.skipError": "Failed to skip onboarding: {error}",
  ...
  "workspaceHeader.help.issueReport.draftTitle": "Bug report",
  ...
  // P2: remote connection failure feedback opens GitHub Issues prefilled
  // (renamed from feedback.submit.template.section.* to neutral keys).
  "remoteConnection.reportIssue.title": "Remote connection failed",
  "remoteConnection.reportIssue.errorSummary": "Error Summary",
  "remoteConnection.reportIssue.notProvided": "Not provided",
  "remoteConnection.reportIssue.logSection": "Connection logs (last 30)",
  "remoteConnection.reportIssue.logEmpty": "No connection logs captured",
  ...
  "taskList.feedbackIssueTitle": "Feedback about task: {title}",
  ...
  // P2: all vendors are flattened into a single neutral list; vendor-specific groups are gone.
  "settings.modelProvider.templateGroup.all": "All templates",
  ...
  "externalFeedback.errorDetailLabel": "Error Details",
  // Subscription failure feedback prefilled context (renamed from feedback.submit.template.section.task*).
  "subscription.error.reportIssue.sessionId": "Session ID: {id}",
  "subscription.error.reportIssue.workspace": "Workspace: {path}",

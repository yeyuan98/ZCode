...
const zhCN: Record<string, string> = {
  ...
  "login.wizard.discoverKey": "测试并发现模型",
  "login.wizard.discoverKeyTesting": "正在测试 API Key 并发现模型...",
  "login.wizard.discoverKeySuccess": "API Key 可用 · {count} 个模型",
  "login.wizard.discoverKeyFail": "测试失败：{error}（仍可保存）",
  "login.wizard.skipConfirm": "再次点击确认跳过",
  "login.wizard.custom.title": "自定义供应商",
  "login.wizard.custom.name": "名称（可选）",
  "login.wizard.custom.baseUrl": "Base URL（OpenAI 兼容）",
  "login.wizard.custom.apiKey": "API Key",
  "login.wizard.custom.requiredError": "请填写 Base URL 和 API Key。",
  ...
  "login.apiKey.providerMissingError": "未找到模板 {templateId} 的内置 provider 配置，请稍后重试。",
  "login.apiKey.saveError": "保存 API key 失败：{error}",
  "login.apiKey.skipError": "跳过首次配置失败：{error}",
  "login.skip": "暂时跳过",
  ...
  "workspaceHeader.help.issueReport.draftTitle": "问题上报",
  ...
  // P2：远程连接失败反馈改为外部 GitHub Issues 预填（原 feedback.submit.template.section.* 键改中性命名）。
  "remoteConnection.reportIssue.title": "远程连接失败",
  "remoteConnection.reportIssue.errorSummary": "报错摘要",
  "remoteConnection.reportIssue.notProvided": "未提供",
  "remoteConnection.reportIssue.logSection": "连接日志（最近 30 条）",
  "remoteConnection.reportIssue.logEmpty": "未捕获到连接日志",
  ...
  "taskList.feedbackIssueTitle": "反馈任务问题：{title}",
  "taskList.resume": "恢复",
  ...
  // P2：所有厂商平铺为单一中性列表，不再保留厂商专属分组。
  "settings.modelProvider.templateGroup.all": "全部模板",
  ...
  "externalFeedback.errorDetailLabel": "报错详情",
  // 订阅失败反馈预填上下文（原 feedback.submit.template.section.task* 键改中性命名）。
  "subscription.error.reportIssue.sessionId": "Session ID: {id}",
  "subscription.error.reportIssue.workspace": "工作区: {path}",
